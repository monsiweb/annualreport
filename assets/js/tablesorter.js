    ...
    (function (t) {
      ...
      var r = (t.tablesorter = {
            ...
            (e.hasInitialized = !1),
              ...
              s.debug &&
                (console[console.group ? "group" : "log"](
                  "Initializing tablesorter v" + r.version
                ),
                t.data(e, "startoveralltimer", new Date())),
              ...
              s.namespace
                ? (s.namespace = "." + s.namespace.replace(r.regex.nonWord, ""))
                : (s.namespace =
              ...
              s.$table.children("caption").length &&
                ((o = s.$table.children("caption")[0]).id ||
                  (o.id = s.namespace.slice(1) + "caption"),
                s.$table.attr("aria-labelledby", o.id)),
              (s.widgetInit = {}),
              (s.textExtraction =
                s.$table.attr("data-text-extraction") ||
                s.textExtraction ||
                "basic"),
              r.buildHeaders(s),
              r.fixColumnWidth(e),
              ...
              r.applyWidget(e, !0),
              s.sortList.length > 0
                ? r.sortOn(s, s.sortList, {}, !s.initWidgets)
                : (r.setHeadersCss(s), s.initWidgets && r.applyWidget(e, !1)),
              s.showProcessing &&
                a
              ...
              s.debug &&
                (console.log(
                  "Overall initialization time:" +
                    r.benchmark(t.data(e, "startoveralltimer"))
                ),
                s.debug && console.groupEnd && console.groupEnd()),
        ...
        bindMethods: function (e) {
          ...
          s.unbind(a.replace(r.regex.spaces, " "))
            ...
            .bind("appendCache" + o, function (e, s, o) {
              e.stopPropagation(),
                r.appendCache(this.config, o),
                t.isFunction(s) && s(this);
            })
            ...
            .bind("resetToLoadState" + o, function (s) {
              ...
              ((e = t.extend(!0, {}, r.defaults, o)).originalSettings = o),
        ...
        bindEvents: function (e, s, o) {
          ...
          !0 !== o &&
            ...
            (a = t.fn.closest
              ...
              "TABLE" === a.nodeName &&
              a !== e &&
              t(a).addClass(i.slice(1) + "_extra_table")),
            (a = (
              n.pointerDown +
              " " +
              n.pointerUp +
            ...
            s
              ...
              .bind(a, function (e, o) {
                ...
                if (
                  !(
                    (1 !== (e.which || e.button) &&
                      !g.match(" " + n.pointerClick + " | sort | keyup ")) ||
                    (" keyup " === g && e.which !== r.keyCodes.enter) ||
                    (g.match(" " + n.pointerClick + " ") &&
                      void 0 !== e.which) ||
                    (g.match(" " + n.pointerUp + " ") &&
                      l !== e.target &&
                      !0 !== o)
                  ...
                  if (g.match(" " + n.pointerDown + " "))
                    return (
                      (l = e.target),
                      void (
                        "1" === (d = c.jquery.split("."))[0] &&
                        d[1] < 4 &&
                        e.preventDefault()
                      )
                    );
                  if (
                    ((l = null),
                    r.regex.formElements.test(e.target.nodeName) ||
                      c.hasClass(n.cssNoSort) ||
                      c.parents("." + n.cssNoSort).length > 0 ||
                      c.parents("button").length > 0)
                  )
                    return !n.cancelSelection;
                  n.delayInit && r.isEmptyObject(n.cache) && r.buildCache(n),
                    (a = t.fn.closest
                      ? t(this).closest("th, td")
                      : /TH|TD/.test(this.nodeName)
                      ? t(this)
                      : t(this).parents("th, td")),
                    (d = s.index(a)),
                    (n.last.clickedIndex = d < 0 ? a.attr("data-column") : d),
                    (i = n.$headers[n.last.clickedIndex]) &&
                      !i.sortDisabled &&
                      r.initSort(n, i, e);
                }
              }),
        ...
        buildHeaders: function (e) {
          ...
          for (
            e.headerList = [],
              ...
              e.sortVars = [],
              e.debug && (a = new Date()),
              e.columns = r.computeColumnIndex(
                e.$table.children("thead, tfoot").children("tr")
              ),
              o = e.cssIcon
                ? '<i class="' +
                  (e.cssIcon === r.css.icon
                    ? r.css.icon
                    : e.cssIcon + " " + r.css.icon) +
                  '"></i>'
                : "",
                  ...
                  if (!g.parent().hasClass(e.cssIgnoreRow))
                    return (
                      ...
                      "" === e.headerTemplate ||
                        ...
                        ((d = e.headerTemplate
                          .replace(r.regex.templateContent, g.html())
                          .replace(
                            r.regex.templateIcon,
                            g.find("." + r.css.icon).length ? "" : o
                          )),
                        e.onRenderTemplate &&
                          (i = e.onRenderTemplate.apply(g, [a, d])) &&
                          "string" == typeof i &&
                          (d = i),
                        g.html(
                          '<div class="' + r.css.headerIn + '">' + d + "</div>"
                        )),
                      e.onRenderHeader &&
                        e.onRenderHeader.apply(g, [a, e, e.$table]),
                      (l = parseInt(g.attr("data-column"), 10)),
                      (s.column = l),
                      (c = r.getOrder(
                        r.getData(g, n, "sortInitialOrder") ||
                          e.sortInitialOrder
                      )),
                      (e.sortVars[l] = {
                        count: -1,
                      ...
                      void 0 !== (c = r.getData(g, n, "lockedOrder") || !1) &&
                        !1 !== c &&
                        ((e.sortVars[l].lockedOrder = !0),
                        (e.sortVars[l].order = r.getOrder(c)
                          ? [1, 1]
                          : [0, 0])),
                      (e.headerList[a] = s),
                      g
            ...
            r.isEmptyObject(e.sortVars[n]) && (e.sortVars[n] = {}),
              ...
              (e.$headerIndexed[n] = s.length
                ? s.not(".sorter-false").length
                  ? s.not(".sorter-false").filter(":last")
                  : s.filter(":last")
                : t());
          e.$table
            .find(e.selectorHeaders)
            .attr({ scope: "col", role: "columnheader" }),
            r.updateHeader(e),
            e.debug &&
              (console.log("Built headers:" + r.benchmark(a)),
        ...
        setupParsers: function (e, t) {
            ...
            if ((s = h[y].rows).length)
              for (i = 0, n = e.columns, l = 0; l < n; l++) {
                if (
                  ...
                  for (i += a, n += a; a + 1 > 0; )
                    (o.parsers[i - a] = p), (o.extractors[i - a] = u), a--;
                i++;
              }
          ...
          e.debug &&
            ...
            console.log("Completed detecting parsers" + r.benchmark(f)),
        ...
        addParser: function (e) {
          var t,
            ...
            o = !0;
          for (t = 0; t < s; t++)
            r.parsers[t].id.toLowerCase() === e.id.toLowerCase() && (o = !1);
        ...
        getParserById: function (e) {
          ...
          var t,
            s = r.parsers.length;
          for (t = 0; t < s; t++)
            if (r.parsers[t].id.toLowerCase() === e.toString().toLowerCase())
              return r.parsers[t];
          return !1;
        },
        detectParserForColumn: function (e, s, o, a) {
          for (
            var n, i, l, d = r.parsers.length, c = !1, g = "", p = !0;
            "" === g && p;
          ...
          return (
            n &&
              (i &&
                ...
                (o = i.format(o, e.table, t, s)),
              (a = "no-parser" === n.id ? "" : n.format("" + o, e.table, t, s)),
        ...
        buildCache: function (e, s, o) {
          ...
          for (
            e.debug && (m = new Date()),
              e.showProcessing && r.isProcessing(T, !0),
              c = 0;
            c < g.length;
            c++
          ) {
            for (
              x = [],
                a = e.cache[c] = { normalized: [] },
                b = (g[c] && g[c].rows.length) || 0,
                l = 0;
              l < b;
              ++l
            )
              if (
                ...
                (p = t(g[c].rows[l])),
                (u = []),
                !p.hasClass(e.selectorRemove.slice(1)))
              )
                if (p.hasClass(e.cssChildRow) && 0 !== l)
                  for (
                    D = a.normalized.length - 1,
                      (w = a.normalized[D][e.columns]).$row = w.$row.add(p),
                      p.prev().hasClass(e.cssChildRow) ||
                        p.prev().addClass(r.css.cssHasChild),
                      f = p.children("th, td"),
                      D = w.child.length,
                      w.child[D] = [],
                      C = 0,
                    ...
                    (h = f[d]) &&
                      ((w.child[D][d] = r.getParsedText(e, h, d)),
                      (v = f[d].colSpan - 1) > 0 && ((C += v), (I += v))),
                      C++;
                else {
                  for (
                    y.$row = p, y.order = l, C = 0, I = e.columns, d = 0;
                    d < I;
                    ++d
                  ) {
                    if (
                      ...
                      (u[C] = i),
                      $ &&
                        "numeric" === (L[C].type || "").toLowerCase() &&
                        (x[C] = Math.max(Math.abs(i) || 0, x[C] || 0)),
                      (v = h.colSpan - 1) > 0)
                    ) {
                      for (R = 0; R <= v; )
                        (i =
          ...
          if ((e.showProcessing && r.isProcessing(T), e.debug)) {
            for (
              ...
              for (C = 0; C < D; C++)
                n["row: " + C] || (n["row: " + C] = {}),
                  (n["row: " + C][e.$headerIndexed[d].text()] =
                    e.cache[0].normalized[C][d]);
        ...
        setHeadersCss: function (e) {
          var s,
            ...
            l = [
              r.css.sortAsc + " " + e.cssAsc,
              r.css.sortDesc + " " + e.cssDesc,
            ],
            ...
            if (
              ...
              ((p = e.$headers.filter(function (t) {
                for (
                  var s = !0,
                    o = e.$headers.eq(t),
                    a = parseInt(o.attr("data-column"), 10),
                    n = a + e.$headers[t].colSpan;
                  a < n;
                  a++
                )
                  s = !!s && (s || r.isValueInArray(a, e.sortList) > -1);
                return s;
              })),
              (p = p
                .not(".sorter-false")
                .filter(
                  '[data-column="' + a[s][0] + '"]' + (1 === n ? ":last" : "")
                )).length)
            ) {
          ...
          for (n = e.$headers.length, s = 0; s < n; s++)
            r.setColumnAriaLabel(e, e.$headers.eq(s));
        },
        setColumnAriaLabel: function (e, s, o) {
          if (s.length) {
            var a = parseInt(s.attr("data-column"), 10),
              n = e.sortVars[a],
              i = s.hasClass(r.css.sortAsc)
                ? "sortAsc"
                : s.hasClass(r.css.sortDesc)
                ? "sortDesc"
                : "sortNone",
              l = t.trim(s.text()) + ": " + r.language[i];
            s.hasClass("sorter-false") || !1 === o
              ? (l += r.language.sortDisabled)
        ...
        updateHeader: function (e) {
          ...
          for (t = 0; t < i; t++)
            (o = e.$headers.eq(t)),
              (a = r.getColumnData(n, e.headers, t, !0)),
              (s =
                "false" === r.getData(o, a, "sorter") ||
                "false" === r.getData(o, a, "parser")),
              r.setColumnSort(e, o, s);
        },
        setColumnSort: function (e, t, r) {
          ...
          (t[0].sortDisabled = r),
            ...
            s &&
              (r ? t.removeAttr("aria-controls") : t.attr("aria-controls", s));
        },
        updateHeaderSortCount: function (e, s) {
          ...
          for (e.sortList = [], i = 0; i < u; i++)
            if (((c = p[i]), (o = parseInt(c[0], 10)) < e.columns)) {
              switch (
                (e.sortVars[o].order ||
                  ((g = r.getOrder(e.sortInitialOrder)
                    ? e.sortReset
                      ? [1, 0, 2]
                      : [1, 0]
                    : e.sortReset
                    ? [0, 1, 2]
                    : [0, 1]),
                  (e.sortVars[o].order = g),
                  (e.sortVars[o].count = 0)),
              ...
              (l = 0 === i ? a : l),
                (n = [o, parseInt(a, 10) || 0]),
                (e.sortList[e.sortList.length] = n),
                (a = t.inArray(n[1], g)),
                (e.sortVars[o].count = a >= 0 ? a : n[1] % g.length);
            }
        },
        updateAll: function (e, t, s) {
          var o = e.table;
          (o.isUpdating = !0),
            r.refreshWidgets(o, !0, !0),
            r.buildHeaders(e),
            r.bindEvents(o, e.$headers, !0),
            r.bindMethods(e),
            r.commonUpdate(e, t, s);
        },
        ...
        updateHeaders: function (e, t) {
          (e.table.isUpdating = !0),
            r.buildHeaders(e),
            r.bindEvents(e.table, e.$headers, !0),
            r.resortComplete(e, t);
        },
        updateCell: function (e, s, o, a) {
          if (t(s).closest("tr").hasClass(e.cssChildRow))
            console.warn(
              'Tablesorter Warning! "updateCell" for child row content has been disabled, use "update" instead'
            );
          else {
            if (r.isEmptyObject(e.cache))
              return r.updateHeader(e), void r.commonUpdate(e, o, a);
            ...
            var n,
              ...
              f = p.index(
                t.fn.closest
                  ? u.closest("tbody")
                  : u.parents("tbody").filter(":first")
              ),
              h = e.cache[f],
              m = t.fn.closest
                ? u.closest("tr")
                : u.parents("tr").filter(":first");
            if (((s = u[0]), p.length && f >= 0)) {
              ...
              (n = r.getElementText(e, s, d)),
                ...
                (c[d] = n),
                "numeric" === (e.parsers[d].type || "").toLowerCase() &&
                  (h.colMax[d] = Math.max(Math.abs(n) || 0, h.colMax[d] || 0)),
                !1 !== (n = "undefined" !== o ? o : e.resort)
                  ? r.checkResort(e, n, a)
                  : r.resortComplete(e, a);
            } else
              e.debug &&
                console.error(
        ...
        addRows: function (s, o, a, n) {
          ...
          if (x) (o = t(o)), s.$tbodies.append(o);
            ...
            !(
              o &&
              o instanceof e &&
              (t.fn.closest ? o.closest("table")[0] : o.parents("table")[0]) ===
                s.table
            )
          )
            return (
          ...
          if (((v.isUpdating = !0), r.isEmptyObject(s.cache)))
            r.updateHeader(s), r.commonUpdate(s, a, n);
          else {
            for (
              g = o.filter("tr").attr("role", "row").length,
                d = s.$tbodies.index(o.parents("tbody").filter(":first")),
                (s.parsers && s.parsers.length) || r.setupParsers(s),
                c = 0;
              c < g;
              c++
            ) {
              for (
                h = 0,
                  u = o[c].cells.length,
                  f = s.cache[d].normalized.length,
                  b = [],
                  m = { child: [], raw: [], $row: o.eq(c), order: f },
                  p = 0;
                p < u;
                p++
              )
                (y = o[c].cells[p]),
                  ...
                  (b[h] = l),
                  "numeric" === (s.parsers[h].type || "").toLowerCase() &&
                    (s.cache[d].colMax[h] = Math.max(
                      Math.abs(l) || 0,
                      s.cache[d].colMax[h] || 0
                    )),
                  (w = y.colSpan - 1) > 0 && (h += w),
                  h++;
        ...
        updateCache: function (e, t, s) {
          (e.parsers && e.parsers.length) || r.setupParsers(e, s),
            r.buildCache(e, t, s);
        },
        appendCache: function (e, t) {
          ...
          for (e.debug && (d = new Date()), l = 0; l < p.length; l++)
            if ((a = p.eq(l)).length) {
              for (
                n = r.processTbody(c, a, !0),
                  o = (s = f[l].normalized).length,
                  i = 0;
                i < o;
                i++
              )
                (u[u.length] = s[i][e.columns].$row),
                  (e.appender &&
                    (!e.pager ||
                      (e.pager.removeRows && g.pager_removeRows) ||
                      e.pager.ajax)) ||
                    n.append(s[i][e.columns].$row);
              r.processTbody(c, n, !1);
            }
          e.appender && e.appender(c, u),
            e.debug && console.log("Rebuilt table" + r.benchmark(d)),
            t || e.appender || r.applyWidget(c),
        ...
        initSort: function (e, s, o) {
          ...
          if (
            (e.$table.triggerHandler("sortStart", u),
            (c = (e.sortVars[h].count + 1) % m.length),
            (e.sortVars[h].count = o[e.sortResetKey] ? 2 : c),
            e.sortRestart)
          )
            for (i = 0; i < f; i++)
              (g = e.$headers.eq(i)),
                h !== (c = parseInt(g.attr("data-column"), 10)) &&
                  (p || g.hasClass(r.css.sortNone)) &&
                  (e.sortVars[c].count = -1);
          if (p) {
            if (
              ((e.sortList = []), (e.last.sortList = []), null !== e.sortForce)
            )
              for (a = e.sortForce, n = 0; n < a.length; n++)
                a[n][0] !== h && (e.sortList[e.sortList.length] = a[n]);
            if (
              (l = m[e.sortVars[h].count]) < 2 &&
              ((e.sortList[e.sortList.length] = [h, l]), s.colSpan > 1)
            )
              for (n = 1; n < s.colSpan; n++)
                (e.sortList[e.sortList.length] = [h + n, l]),
                  (e.sortVars[h + n].count = t.inArray(l, m));
          } else if (
            ((e.sortList = t.extend([], e.last.sortList)),
            r.isValueInArray(h, e.sortList) >= 0)
          )
            for (n = 0; n < e.sortList.length; n++)
              (c = e.sortList[n])[0] === h &&
                ((c[1] = m[e.sortVars[h].count]),
                2 === c[1] &&
                  (e.sortList.splice(n, 1), (e.sortVars[h].count = -1)));
          else if (
            (l = m[e.sortVars[h].count]) < 2 &&
            ((e.sortList[e.sortList.length] = [h, l]), s.colSpan > 1)
          )
          ...
          if (
            ...
            e.sortList.length &&
              e.sortAppend &&
              ((a = t.isArray(e.sortAppend)
                ? e.sortAppend
                : e.sortAppend[e.sortList[0][0]]),
              !r.isEmptyObject(a)))
          )
          ...
          e.$table.triggerHandler("sortBegin", u),
            setTimeout(function () {
              r.setHeadersCss(e),
                r.multisort(e),
                r.appendCache(e),
                e.$table.triggerHandler("sortBeforeEnd", u),
                e.$table.triggerHandler("sortEnd", u);
            }, 1);
        },
        multisort: function (e) {
          ...
          if (!e.serverSideSorting && !r.isEmptyObject(e.cache)) {
            if ((e.debug && (s = new Date()), "object" == typeof d))
              for (o = e.columns; o--; )
                "function" == typeof (a = r.getColumnData(n, d, o)) &&
                  (i[o] = a);
            for (t = 0; t < p; t++)
              (o = e.cache[t].colMax),
                e.cache[t].normalized.sort(function (t, s) {
                  ...
                  for (a = 0; a < g; a++) {
                    ...
                    if (
                      ...
                      p && e.strings[u]
                        ? ((p =
                            "boolean" == typeof r.string[e.strings[u]]
                              ? (l ? 1 : -1) * (r.string[e.strings[u]] ? -1 : 1)
                              : e.strings[u]
                              ? r.string[e.strings[u]] || 0
                              : 0),
                          (h = e.numberSorter
                            ? e.numberSorter(t[u], s[u], l, o[u], n)
                            : r["sortNumeric" + (l ? "Asc" : "Desc")](
                                t[u],
                                s[u],
                                p,
                                o[u],
          ...
          return "" === e && 0 !== i
            ...
            ? "boolean" == typeof i
              ? i
                ...
                : -1
              : i || 1
            : (isNaN(e) && (e = r.getTextValue(e, s, o)),
              isNaN(t) && (t = r.getTextValue(t, s, o)),
              e - t);
        },
        ...
        addWidget: function (e) {
          e.id &&
            !r.isEmptyObject(r.getWidgetById(e.id)) &&
            console.warn('"' + e.id + '" widget was loaded more than once!'),
            (r.widgets[r.widgets.length] = e);
        },
        hasWidget: function (e, r) {
          return (
            ((e = t(e)).length && e[0].config && e[0].config.widgetInit[r]) ||
            !1
          );
        },
        getWidgetById: function (e) {
          ...
          for (t = 0; t < o; t++)
            if (
              (s = r.widgets[t]) &&
              s.id &&
              s.id.toLowerCase() === e.toLowerCase()
            )
              return s;
        },
        applyWidgetOptions: function (e) {
          ...
          if (i)
            for (s = 0; s < i; s++)
              (o = r.getWidgetById(n.widgets[s])) &&
                o.options &&
                ((a = t.extend(!0, {}, o.options)),
                (n.widgetOptions = t.extend(!0, a, n.widgetOptions)),
                t.extend(!0, r.defaults.widgetOptions, o.options));
        },
        addWidgetFromClass: function (e) {
          var t,
            ...
            a =
              "^" +
              o.widgetClass.replace(r.regex.templateName, "(\\S+)+") +
              "$",
            n = new RegExp(a, "g"),
            i = (e.className || "").split(r.regex.spaces);
          if (i.length)
            for (t = i.length, s = 0; s < t; s++)
              i[s].match(n) &&
          ...
          if (
            ...
            if (
              ...
              for (
                ...
                (l = r.getWidgetById(i[a])) && l.id
                  ? (l.priority || (l.priority = 10), (g[a] = l))
                  : c.debug &&
                    console.warn('"' + i[a] + '" widget code does not exist!');
              for (
                g.sort(function (e, t) {
                  ...
                  c.debug &&
                    console[console.group ? "group" : "log"](
                      "Start " + (s ? "initializing" : "applying") + " widgets"
                    ),
                  a = 0;
                a < n;
                a++
        ...
        removeWidget: function (e, s, o) {
          var a,
            ...
            d = (e = t(e)[0]).config;
          if (!0 === s)
            for (s = [], l = r.widgets.length, i = 0; i < l; i++)
              (n = r.widgets[i]) && n.id && (s[s.length] = n.id);
          else
            s = (t.isArray(s) ? s.join(",") : s || "")
              .toLowerCase()
              .split(/[\s,]+/);
          for (l = s.length, a = 0; a < l; a++)
            (n = r.getWidgetById(s[a])),
              (i = t.inArray(s[a], d.widgets)) >= 0 &&
                !0 !== o &&
              ...
              n &&
                ...
                (d.debug &&
                  console.log(
                    (o ? "Refreshing" : "Removing") + ' "' + s[a] + '" widget'
                  ),
                n.remove(e, d, d.widgetOptions, o),
                (d.widgetInit[s[a]] = !1));
        },
        refreshWidgets: function (e, s, o) {
          ...
          for (a = 0; a < d; a++)
            (n = l[a]) &&
              n.id &&
              (s || t.inArray(n.id, i) < 0) &&
              (c[c.length] = n.id);
          r.removeWidget(e, c.join(","), !0),
            !0 !== o
              ? (r.applyWidget(e, s || !1, g), s && r.applyWidget(e, !1, g))
              : g(e);
        },
        ...
        formatFloat: function (e, s) {
          ...
          return (
            (e = (
              s && s.config ? !1 !== s.config.usNumberFormat : void 0 === s || s
            )
              ? e.replace(r.regex.comma, "")
              : e.replace(r.regex.digitNonUS, "").replace(r.regex.comma, ".")),
            r.regex.digitNegativeTest.test(e) &&
              (e = e.replace(r.regex.digitNegativeReplace, "-$1")),
            (o = parseFloat(e)),
            isNaN(o) ? t.trim(e) : o
          );
        },
        isDigit: function (e) {
          return isNaN(e)
            ? r.regex.digitTest.test(
                e.toString().replace(r.regex.digitReplace, "")
              )
            : "" !== e;
        },
          ...
          for (o = 0; o < e.length; o++)
            for (d = e[o].cells, a = 0; a < d.length; a++) {
              ...
              for (
                (f && l.cellIndex === u) ||
                  (l.setAttribute
                    ? l.setAttribute("data-column", u)
                    : t(l).attr("data-column", u)),
                  n = c;
                n < c + g;
                n++
              )
                for (
                  void 0 === h[n] && (h[n] = []), m = h[n], i = u;
                  i < u + p;
                  i++
                )
                  m[i] = "x";
        ...
        fixColumnWidth: function (e) {
          ...
          if (
            (d.length && d.hasClass(r.css.colgroup) && d.remove(),
            l.widthFixed && 0 === l.$table.children("colgroup").length)
          ) {
            for (
              d = t('<colgroup class="' + r.css.colgroup + '">'),
                s = l.$table.width(),
                n = (a = l.$tbodies.find("tr:first").children(":visible"))
                  .length,
                i = 0;
              i < n;
              i++
        ...
        getColumnData: function (e, r, s, o, a) {
          ...
          var n,
            ...
            l = a || i.$headers,
            d =
              (i.$headerIndexed && i.$headerIndexed[s]) ||
              l.filter('[data-column="' + s + '"]:last');
          if (void 0 !== r[s]) return o ? r[s] : r[l.index(d)];
          for (n in r)
            if ("string" == typeof n && d.filter(n).add(d.find(n)).length)
              return r[n];
        },
        ...
        replaceAccents: function (e) {
          ...
          if (!r.characterRegex) {
            ...
            for (t in o)
              "string" == typeof t &&
                ((s += o[t]),
                (r.characterRegexArray[t] = new RegExp("[" + o[t] + "]", "g")));
            r.characterRegex = new RegExp(s + "]");
          }
          if (r.characterRegex.test(e))
            for (t in o)
              "string" == typeof t &&
                (e = e.replace(r.characterRegexArray[t], t));
          return e;
        },
        validateOptions: function (e) {
          ...
          if (l) {
            e.debug && (n = new Date());
            for (s in l)
              if ("undefined" === (a = typeof r.defaults[s]))
                console.warn(
                ...
                for (o in l[s])
                  (a = r.defaults[s] && typeof r.defaults[s][o]),
                    t.inArray(s, i) < 0 &&
                      "undefined" === a &&
                      console.warn(
                        'Tablesorter Warning! "table.config.' +
        ...
        restoreHeaders: function (e) {
          var s,
            ...
            i = n.length;
          for (s = 0; s < i; s++)
            (o = n.eq(s)).find("." + r.css.headerIn).length &&
        ...
        destroy: function (e, s, o) {
          if ((e = t(e)[0]).hasInitialized) {
            ...
            var a,
              ...
              c = d
                .find("tr." + r.css.headerRow)
                .removeClass(r.css.headerRow + " " + i.cssHeaderRow),
              g = n.find("tfoot:first > tr").children("th, td");
            !1 === s &&
              t.inArray("uitheme", i.widgets) >= 0 &&
              ...
              n
                ...
                .unbind(a.replace(r.regex.spaces, " ")),
              i.$headers
                .add(g)
                .removeClass(
                  [
              ...
              r.restoreHeaders(e),
              n.toggleClass(
                r.css.table + " " + i.tableClass + " tablesorter-" + i.theme,
                !1 === s
              ),
      ...
      (t.fn.tablesorter = function (e) {
        return this.each(function () {
          ...
          (o.originalSettings = e),
            !s.hasInitialized && r.buildTable && "TABLE" !== this.nodeName
              ? r.buildTable(s, o)
              : r.setup(s, o);
        });
      }),
        ...
        r.addParser({
          ...
          format: function (e, s) {
            ...
            return (
              e &&
                ((e = t.trim(o.ignoreCase ? e.toLocaleLowerCase() : e)),
                (e = o.sortLocaleCompare ? r.replaceAccents(e) : e)),
              e
            );
          },
          type: "text",
        ...
        r.addParser({
          ...
          format: function (e, s) {
            ...
            return e && "number" == typeof o
              ? o
              : e
              ? t.trim(e && s.config.ignoreCase ? e.toLocaleLowerCase() : e)
              : e;
          },
          type: "numeric",
        }),
        ...
        r.addParser({
          ...
          is: function (e) {
            return (
              (e = (e || "").replace(r.regex.currencyReplace, "")),
              r.regex.currencyTest.test(e)
            );
          },
          format: function (e, s) {
            var o = r.formatFloat((e || "").replace(r.regex.nondigit, ""), s);
        ...
        r.addParser({
          ...
          is: function (e) {
            return (
              r.regex.usLongDateTest1.test(e) || r.regex.usLongDateTest2.test(e)
            );
          },
          format: function (e, t) {
        ...
        (r.convertFormat = function (e, t) {
          (e = (e || "")
            .replace(r.regex.spaces, " ")
            .replace(r.regex.shortDateReplace, "/")),
            "mmddyyyy" === t
              ? (e = e.replace(r.regex.shortDateXXY, "$3/$1/$2"))
              : "ddmmyyyy" === t
              ? (e = e.replace(r.regex.shortDateXXY, "$3/$2/$1"))
              : "yyyymmdd" === t &&
                (e = e.replace(r.regex.shortDateYMD, "$1/$2/$3"));
          var s = new Date(e);
          ...
          format: function (e, t, s, o) {
            if (e) {
              var a = t.config,
                n = a.$headerIndexed[o],
                i =
                  (n.length && n.data("dateFormat")) ||
                  r.getData(
                    n,
                    r.getColumnData(t, a.headers, o),
                    "dateFormat"
                  ) ||
                  a.dateFormat;
              return (
                n.length && n.data("dateFormat", i), r.convertFormat(e, i) || e
              );
            }
            return e;
          },
        ...
        r.addParser({
          ...
          format: function (e, t) {
            var s,
              ...
              i = n
                ? new Date(
                    "2000/01/01 " + n.replace(r.regex.dateReplace, "$1 $2")
                  )
                : n;
            return i instanceof Date && isFinite(i)
              ? ((s = a instanceof Date && isFinite(a) ? a.getTime() : 0),
                s ? parseFloat(i.getTime() + "." + a.getTime()) : i.getTime())
              : e;
          },
          type: "numeric",
        }),
        ...
        r.addWidget({
          ...
          format: function (e, r, s) {
            var o,
              ...
              p = r.$tbodies.add(
                t(r.namespace + "_extra_table").children(
                  "tbody:not(." + r.cssInfoBlock + ")"
                )
              );
            for (l = 0; l < p.length; l++)
              for (
                n = 0,
                  c = (o = p.eq(l).children("tr:visible").not(r.selectorRemove))
                    .length,
                  d = 0;
                d < c;
                d++
                ...
                (a = o.eq(d)),
                  g.test(a[0].className) || n++,
                  (i = n % 2 == 0),
                  a
                    .removeClass(s.zebra[i ? 1 : 0])
                    .addClass(s.zebra[i ? 0 : 1]);
          },
          remove: function (e, t, s, o) {
            if (!o) {
              ...
              for (a = 0; a < i.length; a++)
                (n = r.processTbody(e, i.eq(a), !0)).children().removeClass(l),
                  r.processTbody(e, n, !1);
            }
          },
        });
    })(e),
